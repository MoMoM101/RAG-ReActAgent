...
| 指标 | 数值 |
|------|:---:|
| Precision@5 | 参见 `evaluation_results_v2.json` |
| Recall@5 | 参见 `evaluation_results_v2.json` |
| MRR (首条命中排名) | 参见 `evaluation_results_v2.json` |
| NDCG@5 | 参见 `evaluation_results_v2.json` |
| Hit@5 (至少命中1条) | 参见 `evaluation_results_v2.json` |
