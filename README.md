...
![Faithfulness](https://img.shields.io/badge/回答忠实度-100.00%25-brightgreen)
![Citation](https://img.shields.io/badge/引用精确率-99.62%25-brightgreen)
...
当前阶段：`v0.2.1-beta`；当前发布候选标签：`v0.2.1-beta.3`。
...
快速入口：[产品演示](docs/DEMO.md) · [一键启动](#一键启动) · [系统架构](#系统架构) · [评测结果](#质量评测) · [v0.2.1-beta 发布说明](docs/releases/v0.2.1-beta.md) · [完整项目参考](docs/PROJECT_REFERENCE.md)
