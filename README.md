...
评测数据（qrels v2, chunk_size=200, qwen/text-embedding-v4, dim=1024, 2026-07-11）：
...
> 完整评测数据见 `backend/tests/evaluation_results_v2.json`。运行 `python backend/tests/evaluate_rag.py` 重新生成。
